...
const SelectNumberOfLettersPerWord = ({ setTab }) => {
  const container = {
        ...
        <div className='max-w-xl sm:mx-auto lg:max-w-2xl'>
          <div className='flex flex-col text-center w-full mb-20'>
            ...
            <h2 className='max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white sm:text-4xl mx-auto'>
              Select number of letters per word
            </h2>
              ...
              >
                ...
                >
                  <div className='w-full flex flex-col gap-4 items-center mt-10'>
                    <BlackButton text='Previous' onClick={() => setTab(1)} />
                  </div>
                </motion.li>
              </motion.ul>
            </div>
...
export default SelectNumberOfLettersPerWord;
